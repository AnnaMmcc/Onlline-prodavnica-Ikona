    ...
    <div style="display: flex; flex-direction: column; gap: 1.5rem;">
        ...
        <div>
            ...
            <ul class="ps-3">
                ...
                <li><i class=" fas fa-check-circle text-success me-2"></i>Завршите поруџбину онлајн</li>
                <li><i class="fas fa-check-circle text-success me-2"></i>Достава се врши у најкраћем року, платите приликом доставе</li>
            </ul>
        </div>
        ...
        <div>
            ...
            <ul class="ps-3">
                ...
                <li><i class="fas fa-check-circle text-success me-2"></i>Ако желите сличну икону, или потпуно јединствену по вашој жељи, могуће је наручити:</li>
                <ul>
