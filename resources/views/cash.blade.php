...
<div class="container text-center m-3">
    ...
    <p>Iznos: <strong>{{ $order->total_price }} РСД</strong></p>
    <p>Контактираћемо Вас ради потврде поруџбине. Поруџбина стиже у року од 3-5 радних дана.Платите куриру приликом доставе наведени износ.</p>
