...
@section("Sadrzaj")
    ...
    <img src="{{ asset('storage/images/za sajt_8ac40d91-1255-47b2-863e-f8c32c1414b6.webp') }}"
         class="hero-image"
         alt="Иконописна радионица Анђел Шевић">
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6">
            <div class="quote-card light">
                <p>
                    Од свих видова сведочанстава Православља у наше дане, да ли је нешто силније и убедљивије уверило свет, све хришћанске земље са духовно различитим традицијама, од безгласне, а тако красноречиве проповеди православне иконе?
                </p>
